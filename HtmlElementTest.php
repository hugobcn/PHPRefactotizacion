...
class HtmlElementTest extends TestCase {
    ...
    function it_generates_a_paragraph_with_content() {
        ...
        $this->assertSame(
                '<p>Este es el contenido</p>', $element->render()
        );
    }
    ...
    function it_generates_a_paragraph_with_content_and_an_id_attribute() {
        ...
        $this->assertSame(
                '<p id="my_paragraph">Este es el contenido</p>', $element->render()
        );
    }
    ...
    function it_generates_a_paragraph_with_multiple_attributes() {
        ...
        $this->assertSame(
                '<p id="my_paragraph" class="paragraph">Este es el contenido</p>', $element->render()
        );
    }
    ...
    function it_escapes_the_html_attributes() {
        ...
        $this->assertSame(
                '<img src="img/styde.png" title="Curso de &quot;Refactorizaci&oacute;n&quot; en Styde">', $element->render()
        );
    }
